...
test('BeforeShowDay', function(){
    ...
    equal(target.attr('title'), 'App tooltip', '25th has tooltip');
...
test('BeforeShowMonth', function () {
    ...
    equal(target.attr('title'), 'App tooltip', '1st has tooltip');
...
test('BeforeShowYear', function () {
    ...
    equal(target.attr('title'), 'App tooltip', '5th has tooltip');
