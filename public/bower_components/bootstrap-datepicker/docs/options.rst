...
Days of the week that should be disabled. Values are 0 (Sunday) to 6 (Saturday). Multiple values should be comma-separated. App: disable weekends: ``'06'`` or ``'0,6'`` or ``[0,6]``.
...
Days of the week that should be highlighted. Values are 0 (Sunday) to 6 (Saturday). Multiple values should be comma-separated. App: highlight weekends: ``'06'`` or ``'0,6'`` or ``[0,6]``.
