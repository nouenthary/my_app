  ...
  <body>
    ...
    <div class="container">
	  ...
	  <table>
		...
		<tr>
		  <td><a href="#example-22">App 22</a></td>
		  <td>Highlight ranges on slider with <strong>rangeHighlights</strong> attribute</td>
		</tr>
		<tr>
		  <td><a href="#example-23">App 23</a></td>
		  <td>Using tick marks at specific positions</td>
		</tr>
		<tr>
		  <td><a href="#example-24">App 24</a></td>
		  <td>rtl mode (auto)</td>
		</tr>
		<tr>
		  <td><a href="#example-25">App 25</a></td>
		  <td>Lock selection to ticks</td>
		</tr>
		<tr>
			<td><a href="#example-26">App 26</a></td>
      ...
      <div class="examples">
      	<div id="example-1" class='slider-example'>
      		<h3>App 1: <a href="#top"><small>Back to Top</small></a></h3>
...
#ex1Slider .slider-selection {
	background: #BABABA;
      	...
      	<div id="example-2" class='slider-example'>
      		<h3>App 2: <a href="#top"><small>Back to Top</small></a></h3>
...
var slider = new Slider('#ex2', {});
      	...
      	<div id="example-3" class='slider-example'>
      		<h3>App 3: <a href="#top"><small>Back to Top</small></a></h3>
...
#R, #G, #B {
	width: 300px;
      	...
      	<div id="example-4" class='slider-example'>
      		<h3>App 4: <a href="#top"><small>Back to Top</small></a></h3>
...
var slider = new Slider("#ex4", {
	reversed : true
      	...
      	<div id="example-5" class='slider-example'>
      		<h3>App 5: <a href="#top"><small>Back to Top</small></a></h3>
...
$("#destroyEx5Slider").click(function() {
	...
	slider.destroy();
      	...
      	<div id="example-6" class='slider-example'>
      		<h3>App 6: <a href="#top"><small>Back to Top</small></a></h3>
...
slider.on("slide", function(sliderValue) {
	document.getElementById("ex6SliderVal").textContent = sliderValue;
      	...
      	<div id="example-7" class='slider-example'>
      		<h3>App 7: <a href="#top"><small>Back to Top</small></a></h3>
...
$("#ex7-enabled").click(function() {
	if(this.checked) {
      ...
      <div id="example-8" class='slider-example'>
      		<h3>App 8: <a href="#top"><small>Back to Top</small></a></h3>
...
var slider = new Slider("#ex8", {
	tooltip: 'always'
      ...
      <div id="example-9" class='slider-example'>
      		<h3>App 9: <a href="#top"><small>Back to Top</small></a></h3>
...
<div id="example-10" class='slider-example'>
    <h3>App 10: <a href="#top"><small>Back to Top</small></a></h3>
...
.slider-handle.custom::before {
  ...
  <div id="example-11" class='slider-example'>
      <h3>App 11: <a href="#top"><small>Back to Top</small></a></h3>
...
var slider = new Slider("#ex11", {
  ...
  <div id="example-12" class='slider-example'>
    <h3>App 12: <a href="#top"><small>Back to Top</small></a></h3>
...
#slider12c .slider-selection {
  ...
  <div id="example-13" class='slider-example'>
      <h3>App 13: <a href="#top"><small>Back to Top</small></a></h3>
...
var slider = new Slider("#ex13", {
	...
	<div id="example-14" class='slider-example'>
      <h3>App 14: <a href="#top"><small>Back to Top</small></a></h3>
...
var slider = new Slider("#ex14", {
    ...
    ticks_snap_bounds: 30
      	...
      	<div id="example-15" class='slider-example'>
      		<h3>App 15: <a href="#top"><small>Back to Top</small></a></h3>
...
var slider = new Slider('#ex15', {
	...
	step: 10
      ...
      <div id="example-16" class="slider-example">
        <h3>App 16: <a href="#top"><small>Back to Top</small></a></h3>
...
var sliderB = new Slider("#ex16b", { min: 0, max: 10, value: [0, 10], focus: true });
      ...
      <div id="example-17" class="slider-example">
      		<h3>App 17: <a href="#top"><small>Back to Top</small></a></h3>
...
var sliderB = new Slider("#ex17b", {
	...
	tooltip_position:'left'
      ...
      <div id="example-18" class="slider-example">
        <h3>App 18: <a href="#top"><small>Back to Top</small></a></h3>
...
<h5>HTML</h5>
<pre><code class="html">
&lt;span id="ex18-label-1" class="hidden"&gt;App slider label&lt;/span&gt;
&lt;input id="ex18a" type="text"/&gt;

&lt;span id="ex18-label-2a" class="hidden"&gt;App low value&lt;/span&gt;
&lt;span id="ex18-label-2b" class="hidden"&gt;App high value&lt;/span&gt;
&lt;input id="ex18b" type="text"/&gt;
</pre></code>
...
var sliderB = new Slider("#ex18b", {
	...
	labelledby: ['ex18-label-2a', 'ex18-label-2b']
      ...
      <div  id="example-19" class="slider-example">
        <h3>App 19: <a href="#top"><small>Back to Top</small></a></h3>
...
<pre><code class="html">
 &lt;span id="ex18-label-1" class="hidden">App slider label&lt;/span&gt;
      ...
      <div  id="example-20" class="slider-example">
        <h3>App 20: <a href="#top"><small>Back to Top</small></a></h3>
...
<pre><code class="js">
 $('#ex20a').on('click', function(e) {
      ...
      <div id="example-21" class="slider-example">
        <h3>App 21: <a href="#top"><small>Back to Top</small></a></h3>
...
<pre><code class="html">
 &lt;input id="ex21" type="text"
    ...
    <div id="example-22" class="slider-example">
		  <h3>App 22: <a href="#top"><small>Back to Top</small></a></h3>
...
#slider22 .slider-rangeHighlight.category2 {
    background: #99CC00;
		...
		<h3>App 23: <a href="#top"><small>Back to Top</small></a></h3>
		<p>Using tick marks at specific positions.</p>
		<div class="well">
...
var slider = new Slider("#ex23", {
	...
	step: 0.01
			...
			<div id="example-24" class='slider-example'>
				<h3>App 24: <a href="#top"><small>Back to Top</small></a></h3>
				<p>rtl mode (auto).</p>
...
$("#ex24").slider({});
		  ...
		  <div id="example-25" class='slider-example'>
			  <h3>App 25: <a href="#top"><small>Back to Top</small></a></h3>
...
$("#ex25").slider({
	...
	lock_to_ticks: true
			...
			<div id="example-26" class='slider-example'>
				<h3>App 26: <a href="#top"><small>Back to Top</small></a></h3>
