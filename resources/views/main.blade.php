...
<head>
    ...
    <!-- Select2 -->
    <link rel="stylesheet" href="{{ URL::asset('public/bower_components/select2/dist/css/select2.min.css')}}">
    ...
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link
        href="https://fonts.googleapis.com/css2?family=Battambang&family=Kantumruy+Pro&family=Roboto:wght@500&display=swap"
        rel="stylesheet">
    <style>
        body {
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                {{--                    <img src="/uploads/photo/male.png" class="img-circle" alt="User Image"> --}}
                {{--                </div> --}}
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview" id="categories" style="display: {{ $category }}">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="{{ url('create_categories') }}"><i class="fa fa-circle-o"></i>
                                    {{ __('language.add_category') }}</a>
                            </li>
                        </ul>
                    </li>
                  ...
                  <ul class="treeview-menu">
                    ...
                    {{--                <li><a href="{{url('post_logout')}}"><i class="fa fa-circle-o text-red"></i> <span>Logout</span></a> --}}
                    {{--                </li> --}}
